...
@interface StacManPostMethods : NSObject
-(id)initWithClient:(StacManClient*)client;

//getAll(String site, String filter, Integer page, Integer pagesize, Date fromdate, Date todate, PostSort sort, Date mindate, Date maxdate, Integer min, Integer max, Order order)
...
//getByIds(String site, Integer[] ids, String filter, Integer page, Integer pagesize, Date fromdate, Date todate, PostSort sort, Date mindate, Date maxdate, Integer min, Integer max, Order order)
...
//getRevisions(String site, Integer[] ids, String filter, Integer page, Integer pagesize, Date fromdate, Date todate)
