...
@implementation NSString (SM_GTMNSStringHTMLAdditions)

- (NSString *)_SM_gtm_stringByEscapingHTMLUsingTable:(HTMLEscapeMap*)table
...
- (NSString *)_SM_gtm_stringByEscapingForHTML {
  return [self _SM_gtm_stringByEscapingHTMLUsingTable:gUnicodeHTMLEscapeMap
                                           ofSize:sizeof(gUnicodeHTMLEscapeMap) 
                                  escapingUnicode:NO];
} // gtm_stringByEscapingHTML

- (NSString *)_SM_gtm_stringByEscapingForAsciiHTML {
  return [self _SM_gtm_stringByEscapingHTMLUsingTable:gAsciiHTMLEscapeMap 
                                           ofSize:sizeof(gAsciiHTMLEscapeMap) 
                                  escapingUnicode:YES];
} // gtm_stringByEscapingAsciiHTML

- (NSString *)_SM_gtm_stringByUnescapingFromHTML {
